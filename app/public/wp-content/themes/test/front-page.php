...
<p class="mod-p mod-center">Webサイト制作・運用の仕事に携わり17年になりました。<br>今後も、より多くの方々のお役に立てるサービスを提供していきたいと考えています。</p>
</section><!-- /.l-section -->
</div><!-- /.l-main-inner -->
...
<p class="mod-p">カメラ好きのレストランオーナーが、自分の撮った写真をたくさん載せたい、との意向を踏まえ、写真が目立つサイトにしました。また、当時最も効果的と教えてもらったSEO対策を施したことで、「waikiki」、「ワイキキ」で検索すると上位（ほぼ１位）で表示されるようになっていました。</p>
<p class="mod-p">現在もこのサイトは稼働中ですが、プレーヤーが入っていないとFlashが見れなくなっており、またデザインも今時ではないのでリニューアルを進めているところです・・・が、予算的に厳しいみたいです。</p>
</div><!-- /.l-column-inner -->
</div><!-- /.l-column -->
</section><!-- /.l-section-inner -->
...
<p class="mod-p">前職ではバシャログ。にて <a href="http://bashalog.c-brains.jp/author/kouraku.php" target="_blank">kouraku</a> として、仕事に関わる内容を元にフロントエンド目線でアレンジした内容を展開。</p>
</section><!-- /.l-section-inner -->
</div><!-- /.l-main-inner -->
</div><!-- /.l-section -->
</div><!-- /.l-main-inner -->
